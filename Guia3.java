...
public class Guia3 {
  public static void main(String[] args)
    {
        System.out.println("Prueba EJ1");
        
        Point punto = new Point();
        Point punto1 = new Point(3,5.0);
        
        System.out.println("punto " + punto.getX());
        System.out.println("punto " + punto.getY());
        System.out.println("punto " + punto.add(punto1).getX());
        System.out.println("punto " + punto.add(punto1).getY());
        System.out.println("punto1 " + punto1.getX());
        System.out.println("punto1 " + punto1.getY());
        System.out.println("punto1 " + punto1.add(punto).getX());
        System.out.println("punto1 " + punto1.add(punto).getY());
